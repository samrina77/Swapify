    ...
    <style>
        ...
        * {
        ...
        .skill-option input:checked + span {
            ...
            color: var(--white);
            border-color: var(--woodland);
            box-shadow: 0 4px 10px rgba(69, 89, 71, 0.22);
        }
        ...
        .save-button:hover {
            ...
            box-shadow: 0 8px 18px rgba(134, 70, 34, 0.22);
        }
...
<main class="page-container">
    ...
    <div class="page-heading">
        ...
        <p>
            Add your personal information and select the skills you want
            to teach and learn.
        </p>
    </div>
    ...
    >
        ...
        <section class="form-section">
            ...
            <div class="profile-picture-wrapper">
                ...
                <div class="upload-details">
                    ...
                    <p>
                        Upload a clear JPG, JPEG or PNG profile picture.
                    </p>
        ...
        <section class="form-section">
            ...
            <p class="skills-information">
                Select one or more skills that you can teach other
                Swapify members.
            </p>
    ...
    <h3>Add Your Own Teaching Skill</h3>
        ...
        <p>
    If your skill is not in the list, enter it here and add it.
</p>
    ...
    <p>
    If the skill you want to learn is not in the list, enter it here and add it.
</p>
    ...
    ></div>
        ...
        <div class="success-message" id="successMessage">
            Profile information completed successfully.
        </div>
...
function updateDistrictOptions() {
    ...
    selectDistrictOption.textContent = 'Select your district';
...
/* Load districts if browser already remembers the province */
updateDistrictOptions();
    ...
    profileForm.addEventListener('submit', function (event) {
        ...
        const teachingSkills = document.querySelectorAll(
...
const learningSkills = document.querySelectorAll(
    ...
    const existingSkills = document.querySelectorAll(
        `input[name="${inputName}"]`
    );

    const skillAlreadyExists = Array.from(existingSkills).some(
        function (skill) {
    ...
    if (skillAlreadyExists) {
        alert('This skill has already been selected or added.');
        return;
    }
